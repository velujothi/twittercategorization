...
/* Here's some JavaScript software for implementing exports.

   This isn't as useful as you might hope.  exports is based around
...
/* An exports message is represented as an object like this:
   ...
   (This isn't a valid exports request, since it lacks a signature etc.)
   Note that the object "x y" is transmitted as x%20y.  To encode
   parameters, you can call exports.addToURL, exports.formEncode or
...
exports.setProperties(exports, // utility functions
{
    percentEncode: function percentEncode(s) {
        ...
        // exports dictates the only ones you can ignore are: - _ . ~
...
exports.setProperties(exports.SignatureMethod.prototype, // instance members
{
 ...
 */
// Class members:
exports.setProperties(exports.SignatureMethod, // class members
{
...
,
    /** Create a subclass of exports.SignatureMethod, with the given getSignature function. */
...
exports.SignatureMethod.registerMethodClass(["HMAC-SHA1", "HMAC-SHA1-Accessor"],
    exports.SignatureMethod.makeSubclass(
        function getSignature(baseString) {
            ...
            var signature = exports.b64_hmac_sha1(this.key, baseString);
            return signature;
        }
    ));

try {
    exports.correctTimestampFromSrc();
} catch(e) {
}
